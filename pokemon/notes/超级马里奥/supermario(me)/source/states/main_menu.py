...
class MainMenu:
    ...
    def setup_background(self):
        self.background = setup.GRAPHICS['level_1'] # 拿到了level1的图片
        ...
        self.viewpoint = setup.SCREEN.get_rect() # 游戏框的位置和大小
    ...
    def update(self, surface, keys): # 这里的surface是游戏框

        self.update_cursor(keys)

        surface.blit(self.background, self.viewpoint) # 把背景图画到矩阵上
