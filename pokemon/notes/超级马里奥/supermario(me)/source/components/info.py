...
class Info:
    ...
    def create_state_labels(self):
        ...
        if self.state == 'main_menu':
            ...
            self.state_labels.append((self.create_label('TOP - '), (290, 460)))
            self.state_labels.append((self.create_label('000000'), (400, 460)))
    ...
    def create_info_labels(self):
        ...
        self.info_labels.append((self.create_label('1 - 1'), (400, 55)))
